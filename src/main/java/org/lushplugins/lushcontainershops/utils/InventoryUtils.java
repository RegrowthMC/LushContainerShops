...
public class InventoryUtils {
     ...
     */
    public static @Nullable InventoryChangeSnapshot prepareToTake(Map<Integer, ItemStack> inventoryContents, ShopItem item) {
        InventoryChangeSnapshot snapshot = new InventoryChangeSnapshot();
        ...
        for (Map.Entry<Integer, ItemStack> entry : inventoryContents.entrySet()) {
            ...
            if (remainingToTake >= stackSize) {
                snapshot.removeItem(slot, itemStack);
                ...
                snapshot.removeItem(slot, takenItem);
                snapshot.addChange(slot, inventoryItem);
    ...
    public static @Nullable InventoryChangeSnapshot prepareToTake(Inventory inventory, ShopItem item) {
